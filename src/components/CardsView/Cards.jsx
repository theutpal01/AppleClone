...
const Cards = () => {
	return (
		<div className='grid grid-cols-1 md:grid-cols-2 gap-y-15 gap-x-5 p-5'>
			...
			<Card bg="bg-[url(/cards/one.jpg)]" className='flex relative items-center text-center sm:pt-10 md:pt-8'>
			...
			<Card bg="bg-[url(/cards/two.png)]" className='flex items-center text-center sm:pd-10 md:pb-8'>
				<div className='w-1/2 text-slate-950 flex flex-col items-center justify-end h-full space-y-3 pb-8 md:pb-0'>
			...
			<Card bg="bg-[url(/cards/three.jpg)]" className='flex items-center text-center sm:pt-10 md:pt-8'>
				<div className='w-10/12 lg:w-1/2 text-slate-950 flex flex-col items-center justify-end space-y-3 pt-8 md:pt-0'>
			...
			<Card bg="bg-[url(/cards/four.jpg)]" className='flex items-center text-center sm:pt-10 md:pt-8'>
				<div className='w-10/12 lg:w-1/2 text-white flex flex-col items-center justify-end space-y-3 pt-8 md:pt-0'>
			...
			<Card bg="bg-[url(/cards/five.jpg)] flex items-center text-center h-full justify-end sm:pb-10 md:pb-8">
				<div className='w-10/12 lg:w-1/2 text-white flex flex-col items-center justify-end space-y-3 pb-8 md:pb-0'>
			...
			<Card bg="bg-[url(/cards/six.jpg)] flex items-center pt-32 md:pt-8">
				<div className='w-10/12 lg:w-1/2 text-slate-950 flex flex-col items-center text-center justify-end space-y-3 sm:pt-10 md:pt-0'>
