...
const Product2 = () => {
	return (
		<div className='h-screen w-full bg-[url(/hero/two-mobile.jpg)] md:bg-[url(/hero/two.jpg)] flex flex-col bg-center justify-between items-center bg-no-repeat bg-cover text-white py-10'>
