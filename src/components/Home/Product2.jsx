...
const Product2 = ({className}) => {
	return (
		<div className={`${className} h-screen w-screen bg-[url(/hero/two-mobile.jpg)] md:bg-[url(/hero/two.jpg)] flex flex-col bg-center justify-between items-center bg-no-repeat bg-cover text-white py-10`}>
