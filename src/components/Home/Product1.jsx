...
const Product1 = () => {
	return (
		<div className='h-screen w-full bg-[url(/hero/one-mobile.jpg)] md:bg-[url(/hero/one.jpg)] bg-center flex flex-col justify-between items-center bg-no-repeat bg-cover text-white py-10'>
