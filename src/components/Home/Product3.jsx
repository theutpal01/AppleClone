...
const Product3 = ({ className }) => {
	return (
		<div className={`${className} h-screen w-screen bg-[url(/hero/three-mobile.jpg)] md:bg-[url(/hero/three.jpg)] flex flex-col justify-normal items-center bg-no-repeat bg-contain bg-center bg-[#f5f5f7] text-white py-5 space-y-5`}>
